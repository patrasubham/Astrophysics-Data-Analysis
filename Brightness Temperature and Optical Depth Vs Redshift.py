#Brightness Temperature and Optical Depth Vs Redshift(z)
...
for T_s in [1,10,100]:
    ...
    for i in range (len(z1)):
        #Formulae used to calculate optical depth and Brightness Temperature 
    ...
    plt.xlabel('z')
    plt.ylabel('\u03C4_\u03C5')
    plt.title('Optical Depth vs Redshift(z)')
    plt.figure(2)
    ...
    plt.xlabel('z')
    plt.ylabel('T_b')
    plt.title('Brightness Teperature vs Redshift(z)')
plt.show()
